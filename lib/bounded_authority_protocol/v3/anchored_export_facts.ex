defmodule BoundedAuthorityProtocol.V3.AnchoredExportFacts do
...
defimpl Inspect, for: BoundedAuthorityProtocol.V3.AnchoredExportFacts do
  def inspect(_value, _options),
    do: Inspect.Algebra.string("#BoundedAuthorityProtocol.V3.AnchoredExportFacts<redacted>")
end
