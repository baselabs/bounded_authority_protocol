defmodule BoundedAuthorityProtocol.V3.EnvelopeFacts do
...
defimpl Inspect, for: BoundedAuthorityProtocol.V3.EnvelopeFacts do
  def inspect(_value, _options),
    do: Inspect.Algebra.string("#BoundedAuthorityProtocol.V3.EnvelopeFacts<redacted>")
end
