defmodule BoundedAuthorityProtocol.V3.KeyTransitionFacts do
...
defimpl Inspect, for: BoundedAuthorityProtocol.V3.KeyTransitionFacts do
  def inspect(_value, _options),
    do: Inspect.Algebra.string("#BoundedAuthorityProtocol.V3.KeyTransitionFacts<redacted>")
end
