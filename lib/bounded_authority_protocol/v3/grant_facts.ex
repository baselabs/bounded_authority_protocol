defmodule BoundedAuthorityProtocol.V3.GrantFacts do
...
defimpl Inspect, for: BoundedAuthorityProtocol.V3.GrantFacts do
  def inspect(_value, _options),
    do: Inspect.Algebra.string("#BoundedAuthorityProtocol.V3.GrantFacts<redacted>")
end
