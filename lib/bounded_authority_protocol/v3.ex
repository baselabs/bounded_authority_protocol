defmodule BoundedAuthorityProtocol.V3 do
  @moduledoc """
  Explicit entry point for the v3 wire profile (contract-major 3, the
  [`BAP3-ES256-SHA256`](../docs/design/registries.md) suite).
  ...
  ([ADR 0035](../docs/adr/0035-es256-contract-major-activation.md)). Each major
  ...
  alias BoundedAuthorityProtocol.V3.Runtime
  ...
  @doc "Assembles a validated signing input and raw ES256 signature at profile maxima."
  ...
  @doc "Assembles a validated signing input and raw ES256 signature under caller bounds."
  ...
  defp closed_header([], <<"ES256">>, <<"ba+cap">>, kid) when is_binary(kid), do: {:ok, kid}
