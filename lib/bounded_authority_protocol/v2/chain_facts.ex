defmodule BoundedAuthorityProtocol.V2.ChainFacts do
...
defimpl Inspect, for: BoundedAuthorityProtocol.V2.ChainFacts do
  def inspect(_value, _options),
    do: Inspect.Algebra.string("#BoundedAuthorityProtocol.V2.ChainFacts<redacted>")
end
