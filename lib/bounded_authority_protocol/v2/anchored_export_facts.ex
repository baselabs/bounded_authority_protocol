defmodule BoundedAuthorityProtocol.V2.AnchoredExportFacts do
...
defimpl Inspect, for: BoundedAuthorityProtocol.V2.AnchoredExportFacts do
  def inspect(_value, _options),
    do: Inspect.Algebra.string("#BoundedAuthorityProtocol.V2.AnchoredExportFacts<redacted>")
end
