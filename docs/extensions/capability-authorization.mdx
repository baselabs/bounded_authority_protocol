...
the extension's negotiation, transport-binding, and graceful-degradation surfaces (§ 4) are
normative requirements this extension defines for MCP per
[SEP-2133](https://modelcontextprotocol.io/seps/2133-extensions), not restatements of v1.
...
core MCP protocol behavior (the core authorization framework defined in the MCP specification), as
