...
defmodule BoundedAuthorityProtocol.PackageCheck do
  ...
  @expected_files MapSet.new([
                    ...
                    "lib/bounded_authority_protocol/v2.ex",
                    "lib/bounded_authority_protocol/v2/anchor_facts.ex",
                    "lib/bounded_authority_protocol/v2/anchored_export_codec.ex",
                    "lib/bounded_authority_protocol/v2/anchored_export_facts.ex",
                    ...
                    "lib/bounded_authority_protocol/v2/decoded_grant.ex",
                    "lib/bounded_authority_protocol/v2/decoded_proof.ex",
                    "lib/bounded_authority_protocol/v2/envelope_facts.ex",
                    "lib/bounded_authority_protocol/v2/grant.ex",
                    ...
                    "lib/bounded_authority_protocol/v2/operation.ex",
                    "lib/bounded_authority_protocol/v2/proof.ex",
                    "lib/bounded_authority_protocol/v2/request_digest.ex",
                    "lib/bounded_authority_protocol/v2/runtime.ex",
                    "lib/bounded_authority_protocol/v2/selector.ex",
                    "mix.exs",
                    ...
                    "priv/conformance/v2/corpus/cases/anchored-export/encode.json",
                    "priv/conformance/v2/corpus/cases/anchored-export/verify.json",
                    "priv/conformance/v2/corpus/cases/assemble-compact/assemble.json",
                    "priv/conformance/v2/corpus/cases/base64url/decode.json",
                    "priv/conformance/v2/corpus/cases/boundary-anchor/verify.json",
                    "priv/conformance/v2/corpus/cases/bounds/new.json",
                    "priv/conformance/v2/corpus/cases/consumption-chain/check.json",
                    "priv/conformance/v2/corpus/cases/consumption-chain/entry.json",
                    "priv/conformance/v2/corpus/cases/envelope/check.json",
                    "priv/conformance/v2/corpus/cases/envelope/gap-classes.json",
                    "priv/conformance/v2/corpus/cases/grant-decode/decode.json",
                    "priv/conformance/v2/corpus/cases/grant-verify/verify.json",
                    "priv/conformance/v2/corpus/cases/jcs/encode.json",
                    "priv/conformance/v2/corpus/cases/json/decode-depth-scalar-inner-exact.raw",
                    "priv/conformance/v2/corpus/cases/json/decode-string_bytes-exact.raw",
                    "priv/conformance/v2/corpus/cases/json/decode-string_bytes-plus.raw",
                    "priv/conformance/v2/corpus/cases/json/decode-total_nodes-plus.raw",
                    "priv/conformance/v2/corpus/cases/json/decode.json",
                    "priv/conformance/v2/corpus/cases/json/magnitude-plus-one.raw",
                    "priv/conformance/v2/corpus/cases/json/magnitude.json",
                    "priv/conformance/v2/corpus/cases/jwk/jwk.json",
                    "priv/conformance/v2/corpus/cases/key-locator/untrusted.json",
                    "priv/conformance/v2/corpus/cases/key-transition/verify.json",
                    "priv/conformance/v2/corpus/cases/proof-decode/decode.json",
                    "priv/conformance/v2/corpus/cases/request-digest/digest.json",
                    "priv/conformance/v2/corpus/cases/signing-input/anchor.json",
                    "priv/conformance/v2/corpus/cases/signing-input/grant.json",
                    "priv/conformance/v2/corpus/cases/signing-input/proof.json",
                    "priv/conformance/v2/corpus/cases/signing-input/transition.json",
                    "priv/conformance/v2/corpus/cases/uri/normalize.json",
                    "priv/conformance/v2/corpus/index.json",
                    "priv/conformance/v2/corpus/revision.json",
                    "priv/conformance/v3/corpus/cases/anchored-export/encode.json",
                    "priv/conformance/v3/corpus/cases/anchored-export/verify.json",
                    "priv/conformance/v3/corpus/cases/assemble-compact/assemble.json",
                    "priv/conformance/v3/corpus/cases/base64url/decode.json",
                    "priv/conformance/v3/corpus/cases/boundary-anchor/verify.json",
                    "priv/conformance/v3/corpus/cases/bounds/new.json",
                    "priv/conformance/v3/corpus/cases/consumption-chain/check.json",
                    "priv/conformance/v3/corpus/cases/consumption-chain/entry.json",
                    "priv/conformance/v3/corpus/cases/envelope/check.json",
                    "priv/conformance/v3/corpus/cases/envelope/gap-classes.json",
                    "priv/conformance/v3/corpus/cases/grant-decode/decode.json",
                    "priv/conformance/v3/corpus/cases/grant-verify/verify.json",
                    "priv/conformance/v3/corpus/cases/jcs/encode.json",
                    "priv/conformance/v3/corpus/cases/json/decode-depth-scalar-inner-exact.raw",
                    "priv/conformance/v3/corpus/cases/json/decode-string_bytes-exact.raw",
                    "priv/conformance/v3/corpus/cases/json/decode-string_bytes-plus.raw",
                    "priv/conformance/v3/corpus/cases/json/decode-total_nodes-plus.raw",
                    "priv/conformance/v3/corpus/cases/json/decode.json",
                    "priv/conformance/v3/corpus/cases/json/magnitude-plus-one.raw",
                    "priv/conformance/v3/corpus/cases/json/magnitude.json",
                    "priv/conformance/v3/corpus/cases/jwk/jwk.json",
                    "priv/conformance/v3/corpus/cases/key-locator/untrusted.json",
                    "priv/conformance/v3/corpus/cases/key-transition/verify.json",
                    "priv/conformance/v3/corpus/cases/proof-decode/decode.json",
                    "priv/conformance/v3/corpus/cases/request-digest/digest.json",
                    "priv/conformance/v3/corpus/cases/signing-input/anchor.json",
                    "priv/conformance/v3/corpus/cases/signing-input/grant.json",
                    "priv/conformance/v3/corpus/cases/signing-input/proof.json",
                    "priv/conformance/v3/corpus/cases/signing-input/transition.json",
                    "priv/conformance/v3/corpus/cases/uri/normalize.json",
                    "priv/conformance/v3/corpus/index.json",
                    "priv/conformance/v3/corpus/revision.json",
                    "docs/adr/0035-es256-contract-major-activation.md",
                    "docs/adr/0036-role-attestation-profile.md",
                    "lib/bounded_authority_protocol/v3.ex",
                    ...
                    "lib/bounded_authority_protocol/v3/context_validation.ex",
                    "lib/bounded_authority_protocol/v3/decoded_grant.ex",
                    "lib/bounded_authority_protocol/v3/decoded_proof.ex",
                    "lib/bounded_authority_protocol/v3/ec_jwk.ex",
                    "lib/bounded_authority_protocol/v3/envelope_facts.ex",
                    "lib/bounded_authority_protocol/v3/es256.ex",
                    "lib/bounded_authority_protocol/v3/grant.ex",
                    ...
                    "lib/bounded_authority_protocol/v3/operation.ex",
                    "lib/bounded_authority_protocol/v3/proof.ex",
                    "lib/bounded_authority_protocol/v3/request_digest.ex",
                    "lib/bounded_authority_protocol/v3/runtime.ex",
                    "lib/bounded_authority_protocol/v3/selector.ex",
                    "spec/bap-v3.md",
                    "spec/bap-v1.md",
                    "spec/bap-v2.md",
